...
class TestGenerator:
    ...
    def test_generator_initialization(self):
        ...
        generator = Generator(noise_dim=100, output_dim=784, hidden_dims=[256, 512])
...
class TestDiscriminator:
    ...
    def test_discriminator_initialization(self):
        ...
        discriminator = Discriminator(input_dim=784, hidden_dims=[512, 256])
...
class TestWGAN:
    ...
    def test_wgan_train_step(self):
        ...
        trainer = GANTrainer(
            generator, critic, g_optimizer, d_optimizer, torch.device("cpu"), gan_type="wgan"
        )
...
class TestComputeGradientPenalty:
    ...
    def test_gradient_penalty_computation(self):
        ...
        gp = compute_gradient_penalty(critic, real_samples, fake_samples, device, lambda_gp=10.0)
...
class TestGANTrainer:
    ...
    def test_wgan_gp_train_step(self):
        ...
        trainer = GANTrainer(
            generator, critic, g_optimizer, d_optimizer, torch.device("cpu"), gan_type="wgan-gp"
        )

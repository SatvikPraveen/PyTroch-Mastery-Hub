...
class TestSimpleMLP:
    ...
    def test_mlp_initialization(self):
        ...
        model = SimpleMLP(input_size=10, hidden_sizes=[20, 15], output_size=5)
...
class TestDeepMLP:
    ...
    def test_deep_mlp_initialization(self):
        ...
        model = DeepMLP(input_size=10, hidden_size=64, num_layers=3, output_size=5)
...
class TestRNNModels:
    ...
    def test_simple_rnn(self):
        ...
        model = SimpleRNN(input_size=10, hidden_size=20, num_layers=2, output_size=5)
...
class TestTransformerModels:
    ...
    def test_simple_transformer(self):
        ...
        model = SimpleTransformer(
            vocab_size=100, d_model=64, num_heads=4, num_layers=2, num_classes=5
        )
...
class TestAutoEncoders:
    ...
    def test_autoencoder(self):
        ...
        model = AutoEncoder(input_size=784, encoding_dims=[256, 128, 64], activation="relu")
    ...
    def test_variational_autoencoder(self):
        ...
        model = VariationalAutoEncoder(input_size=784, hidden_size=256, latent_size=32)

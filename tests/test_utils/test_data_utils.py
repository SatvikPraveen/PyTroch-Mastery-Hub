...
class TestCreateDataLoaders:
    ...
    def test_create_all_loaders(self, sample_dataset):
        ...
        loaders = create_data_loaders(
            train_dataset, test_dataset=val_dataset, val_dataset=val_dataset, batch_size=8
        )
...
class TestGenerateSyntheticData:
    ...
    def test_generate_classification_data(self):
        ...
        X, y = generate_synthetic_data(
            task="classification", n_samples=100, n_features=5, n_classes=3
        )
    ...
    def test_generate_regression_data(self):
        ...
        X, y = generate_synthetic_data(task="regression", n_samples=50, n_features=3)

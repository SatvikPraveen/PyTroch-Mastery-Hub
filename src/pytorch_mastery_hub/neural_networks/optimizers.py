# pytorch_mastery_hub/neural_networks/optimizers.py
"""
    ...
    def get_lr(self):
        if self.last_epoch < self.warmup_steps:
            ...
            return [
                ...
                * (1 + math.cos(math.pi * cosine_steps / cosine_max_steps))
                / 2
                for base_lr in self.base_lrs
            ]
...
def get_scheduler(
    optimizer: Optimizer, scheduler_name: str = "cosine", **kwargs
...
def configure_optimizer_and_scheduler(model: nn.Module, config: dict[str, Any]) -> tuple:
    """
